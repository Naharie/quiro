...
It supports full logic lookups, number ranges, expressions, and DCGs.
...
The entire interpreter is contained in Interpreter.Internal.fs and all the builtins are defined in Scope.fs.
